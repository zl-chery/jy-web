    ...
    <div class="jy-mainwidth">
      <div class="jy-article--wrap">
        ...
        <div class="jy-hot--body">
          <router-link v-for="item in hotList" :key="item.desc" :to="{path:'/gamePool',query:{id:item.jump_id}}">
            <div class="box">
      ...
      <div class="jy-article--wrap">
        ...
        <div class="jy-play--body">
          <div class="jy-body--left">
            <router-link v-for="item in playList.slice(0, 1)" :key="item.desc" :to="{path:'/gamePool',query:{id:item.jump_id}}">
              <img :src="item.img" alt="">
              <div class="jy-mask">
          ...
          <div class="jy-body--right">
            <router-link class="jy-right--des" v-for="item in playList.slice(1, playList.length)" :key="item.title" :to="{path:'/gamePool',query:{id:item.jump_id}}">
              <img :src="item.img" alt="">
      ...
      <div class="jy-article--wrap">
        ...
        <div class="jy-hotlist jy-list--common">
          ...
          <div class="jy-list--body">
            <ul class="jy-scoed--des">
              <li v-for="(item, index) in hotSortList" :key="item.url">
        ...
        <div class="jy-hotlist jy-list--common">
          ...
          <div class="jy-list--body">
            <ul class="jy-scoed--des">
              <li v-for="(item, index) in highSortList" :key="item.url">
                <router-link :to="{path:'/gamePool', query:{id:item.id}}">
                  <p>{{++index}}</p>
                  <div class="jy-top--des">
                    <img :src="item.game_icon" alt="">
...
export default {
  ...
  methods: {
    //跳转到游戏详情页
    toGamePool(id) {
      // this.$router.push({path:'gamePool',params:{id:id}})
      console.log(this)
      this.$emit('toGamePool', id)
    }
  }
}
</script>

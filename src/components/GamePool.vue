  ...
  <div class="jy-gamepool--bg">
    <div class="jy-mainwidth">
      ...
      >
        ...
        <el-breadcrumb-item>英雄联盟</el-breadcrumb-item>
      </el-breadcrumb>
      <div class="jy-gamepool--info">
        <!-- swiper -->
        <GamePoolSwiper1 />
        <div class="jy-gamepool--des">
          <p class="jy-gamepool--name">孤岛惊魂新曙光</p>
          ...
          <div class="jy-gamepool--tags">
            <el-row>
              <el-button class="button-gray" round>动作</el-button>
              <el-button class="button-gray" round>冒险</el-button>
              <el-button class="button-gray" round>格斗</el-button>
            </el-row>
          </div>
          <p class="jy-game--description">
            由育碧蒙特利尔工作室主研，育碧上海工作室、育碧基辅工作室以及育碧布加勒斯特工作室协助研发的《孤岛惊魂：新曙光》是一款开放世界式的第一人称射击游戏。
          </p>
          <p class="jy-gamepool--version">游戏版本号：V1.23334</p>
      ...
      <GameCommentVue v-show="isComment" />
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changeComponent(value) {
      ...
      this.$router.push(`/gamePool/${this.label[this.activeIndex].path}`)
    },
    //开始游戏

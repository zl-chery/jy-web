      ...
      <div class="jy-personcenter--left">
        <div class="jy-personcenter--user">
          <div class="jy-personcenter--info">
            ...
            <div>
              <p class="jy-personcenter--nickname">Matilda Nguyen</p>
              <p class="jy-personcenter--uid">ID：232265899</p>
            </div>
            <img class="jy-person--vip" src="../assets/img/person-vip.png" alt="">
          </div>
          <div class="jy-personcenter--reset">
            <p class="jy-personcenter--coins">鲸钻 48259</p>
            <p class="jy-personcenter--coins">鲸币 14520</p>
            <p class="jy-personcenter--retire"><i class="el-icon-time"></i> 2小时52分钟【0点重置】</p>
            <p class="jy-personcenter--retire">5小时33分钟【不过期】</p>
          </div>
        </div>
        <div class="jy-personcenter--tool">
          <ul>
            <li @click="changeComponent('first', 0)" :class="{person_is__actived:0==current}">
              <img v-show="tabsActive[0].dective" src="../assets/img/person-vipinfo.png" alt="">
              <img v-show="tabsActive[0].active" src="../assets/img/person-vip-active.png" alt="">
              <p>会员中心</p>
            </li>
            <li @click="changeComponent('second', 1)" :class="{person_is__actived:1==current}">
              <img v-show="tabsActive[1].dective" src="../assets/img/person-like.png" alt="">
              <img v-show="tabsActive[1].active" src="../assets/img/person-like-active.png" alt="">
              <p>我的收藏</p>
            </li>
            <li @click="changeComponent('tirth', 2)" :class="{person_is__actived:2==current}">
              <img v-show="tabsActive[2].dective" src="../assets/img/person-card.png" alt="">
              <img v-show="tabsActive[2].active" src="../assets/img/person-card-active.png" alt="">
              <p>我的卡包</p>
            </li>
            <li @click="changeComponent('forth', 3)" :class="{person_is__actived:3==current}">
              <img v-show="tabsActive[3].dective" src="../assets/img/person-money.png" alt="">
              <img v-show="tabsActive[3].active" src="../assets/img/person-money-active.png" alt="">
              <p>资产记录</p>
            </li>
            <li @click="changeComponent('fifth', 4)" :class="{person_is__actived:4==current}">
              <img v-show="tabsActive[4].dective" src="../assets/img/person-help.png" alt="">
              <img v-show="tabsActive[4].active" src="../assets/img/person-help-active.png" alt="">
              <p>帮助反馈</p>
            </li>
            <li @click="changeComponent('sixth', 5)" :class="{person_is__actived:5==current}">
              <img v-show="tabsActive[5].dective" src="../assets/img/person-msg.png" alt="">
              <img v-show="tabsActive[5].active" src="../assets/img/person-msg-active.png" alt="">
              <p>消息中心</p>
            </li>
            <li @click="changeComponent('seventh', 6)" :class="{person_is__actived:6==current}">
              <img v-show="tabsActive[6].dective" src="../assets/img/person-safe.png" alt="">
              <img v-show="tabsActive[6].active" src="../assets/img/person-safe-active.png" alt="">
              <p>账号安全</p>
            </li>
          </ul>
        </div>

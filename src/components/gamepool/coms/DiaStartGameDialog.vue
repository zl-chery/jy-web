    ...
    <div class="jy-createhome-info">
      ...
      <div class="jy-createHome--card">
        ...
        <div class="jy-startGame--second">
          ...
          <div class="jy-createCard--info">
            <p>秒进卡通道</p>
            <el-button round class="button-card--comment" @click="confirmSecondDialog = true">开通</el-button>
          </div>
        </div>
      </div>
    </div>
...
.jy-createHome--game
  ...
  color #fff
  border-radius 50%
  background url('../../../assets/img/startGame-common-bgc.png') no-repeat
  & img
    width 166px
    height 166px
    border-radius 50%
  ...
  &::after
    ...
    width 167px
    height 166px
    background url('../../../assets/img/startGame-common-after.png') no-repeat

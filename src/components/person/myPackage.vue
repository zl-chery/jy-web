...
<div class="jy-personwidth">
    <div class="jy-wrap--title jy-personcenter--title">
      <p>我的卡包</p>
      <el-tabs class="deleteBorder person-package--tabs" v-model="activeName" @tab-click="changeComponent(activeName)">
...
export default {
  ...
  methods: {
    ...
    changeComponent(value) {
      ...
      this.$router.push(`/personCenter/Package/${this.label[this.activeIndex].path}`)
    }
  }
...
.jy-personwidth .jy-card.jy-cardNouse
  height 316px
